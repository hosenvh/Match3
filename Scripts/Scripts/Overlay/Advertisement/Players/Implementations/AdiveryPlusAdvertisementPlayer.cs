...
{
    [Preserve]
    public class AdiveryPlusAdvertisementPlayer : AdvertisementPlayer
    {
        public static bool FORCE_DISABLE_ADIVERY_DEBUG_MODE;
        ...
        {
            if (FORCE_DISABLE_ADIVERY_DEBUG_MODE)
            {
        ...
        private void RequestAdInternal(string zoneId, Action onAlreadyLoaded, Action<string> onLoadNeeded)
        {
