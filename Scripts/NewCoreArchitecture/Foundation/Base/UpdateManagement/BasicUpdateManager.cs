    ...
    public class BasicUpdateManager : UpdateManager
    {
        ...
        public void Pause(Channel channel)
        {
            if (HasChannel(channel))
            {
                ...
                ServiceLocator.Find<EventManager>().Propagate(new TimeChannelStateChangedEvent(channel,true), this);
            }
        }
        ...
        public void Resume(Channel channel)
        {
            if (HasChannel(channel))
            {
                ...
                ServiceLocator.Find<EventManager>().Propagate(new TimeChannelStateChangedEvent(channel, false), this);
